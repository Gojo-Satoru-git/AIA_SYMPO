...
const useAnimationLoop = (
  ...
  useEffect(() => {
    ...
    if (seqSize > 0) {
      ...
      const roundedOffset = Math.round(offsetRef.current);
    ...
    const animate = (timestamp) => {
      ...
      if (seqSize > 0) {
        ...
        // Round to whole pixels to prevent sub-pixel rendering artifacts
        const roundedOffset = Math.round(offsetRef.current);
        const transformValue = isVertical
          ? `translate3d(0, ${-roundedOffset}px, 0)`
          : `translate3d(${-roundedOffset}px, 0, 0)`;
        ...
        const content = isNodeItem ? (
          <span
            className={cx(
              ...
              scaleOnHover &&
                'group-hover/item:scale-120 transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]'
            )}
          ...
          <img
            className={cx(
              ...
              '[backface-visibility:hidden] [image-rendering:crisp-edges] [will-change:auto]',
              'motion-reduce:transition-none',
              scaleOnHover &&
                'group-hover/item:scale-120 transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]'
            )}
      ...
      >
        ...
        <div
          className={cx(
            ...
            '[backface-visibility:hidden] [transform-origin:0_0] motion-reduce:transform-none',
